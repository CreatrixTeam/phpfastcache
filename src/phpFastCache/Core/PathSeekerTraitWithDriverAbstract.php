...
abstract class PathSeekerTraitWithDriverAbstract extends DriverAbstract
{
    /**
     * @var array
     */
	...
	abstract protected function getFILE_DIR();
    ...
    {
        return $this->getPath() . DIRECTORY_SEPARATOR . $this->getFILE_DIR();
    }
